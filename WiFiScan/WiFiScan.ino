...
#ifndef STASSID
#define STASSID "howsky3d"
#define STAPSK "htsw1234"
#endif
...
void setup(void) {
  ...
  server.on("/led", handleNumericArgs);
  ...
  server.addHook([](const String &, const String &url, WiFiClient *client,
    ...
    if (url.startsWith("/dump")) {
      ...
      //                                             (we already have the
      //                                             example with '/fail' hook)
      // or                                    IS GIVEN and webserver will
      // forget it trying with IS GIVEN and storing it on a dumb WiFiClient.
